...
namespace EPiServer.Find.Cms
{
    public static class CmsClientConventions
    {
        public static void ApplyCmsConventions(IClient client)
        {
            ...
            //ConventionsExtensions.ForInstancesOf<PageData>(client.Conventions).ExcludeField((Expression<Func<PageData, object>>)(x => x.ACL)).IncludeField<DateTime?>((Expression<Func<PageData, DateTime?>>)(x => ContentExtensions.StartPublishedNormalized(x))).IncludeField<IEnumerable<string>>((Expression<Func<PageData, IEnumerable<string>>>)(x => ContentExtensions.SearchCategories(x))).IncludeField<string>((Expression<Func<PageData, string>>)(x => ContentExtensions.SearchTypeName(x))).Field<string>((Expression<Func<PageData, string>>)(x => x.LinkURL)).Modify((System.Action<JsonProperty>)(x => x.ValueProvider = (IValueProvider)new DelegateValueProvider((Func<object, object>)(page => (object)ContentExtensions.LinkURL((PageData)page)), (System.Action<object, object>)null)));
